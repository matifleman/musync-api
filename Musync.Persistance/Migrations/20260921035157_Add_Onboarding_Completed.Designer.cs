...
namespace Musync.Persistance.Migrations
{
    ...
    [Migration("20260921035157_Add_Onboarding_Completed")]
    partial class Add_Onboarding_Completed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BandInstrument", b =>
                {
                    ...
                    b.HasKey("BandId", "InstrumentId");

                    b.HasIndex("InstrumentId");

                    b.ToTable("BandInstrument");
                });
            ...
            modelBuilder.Entity("Musync.Domain.BandFollower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BandFollowers");
                });

            modelBuilder.Entity("Musync.Domain.BandMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BandId", "InstrumentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Musync.Domain.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Musync.Domain.Instrument", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 10,
                            Image = "instruments/synthesizer.svg",
                            Name = "Synthesizer"
                        });
                });
            ...
            modelBuilder.Entity("Musync.Domain.PostLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Musync.Domain.Release", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Musync.Domain.Song", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Musync.Domain.BandFollower", b =>
                {
                    b.HasOne("Musync.Domain.Band", "Band")
                        .WithMany()
                        .HasForeignKey("BandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Musync.Domain.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Musync.Domain.BandMember", b =>
                {
                    ...
                    b.HasOne("Musync.Domain.Instrument", "Instrument")
                        .WithMany()
                        .HasForeignKey("InstrumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Musync.Domain.Comment", b =>
                {
                    ...
                    b.HasOne("Musync.Domain.Post", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("Musync.Domain.Song", b =>
                {
                    b.HasOne("Musync.Domain.Release", "Release")
                        .WithMany("Songs")
