...
{
    public sealed class GetUserFollowingQueryHandler : IRequestHandler<GetUserFollowingQuery, List<UserSearchDTO>>
    {
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ICurrentUserService _currentUserService;

        public GetUserFollowingQueryHandler(UserManager<ApplicationUser> userManager, ICurrentUserService currentUserService)
        {
            _userManager = userManager;
            _currentUserService = currentUserService;
        }

        public async Task<List<UserSearchDTO>> Handle(GetUserFollowingQuery request, CancellationToken cancellationToken)
        {
            ...
            return await _userManager.Users
                .Where(u => u.Followers!.Any(f => f.Id == request.UserId))
